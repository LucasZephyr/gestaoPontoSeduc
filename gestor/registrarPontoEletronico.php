        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Registrar Ponto Eletrônico</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-lg-8"> <!-- inicio coluna a esquerda-->
                    ...
                    <div class="card">
                        <h5 class="card-header">Registre seus horários no mapa abaixo:</h5>
                        <div class="card-body">
                            ...
                            <?php if(count($registroPonto) < 7){ ?>
                                <div class="mt-3">
                                    ...
                                    <div class="mt-3">Endereço aproximado: <br><p id="endereco"></p></div>
